...
/*ASCII字模数据声明(已统一使用6*8字库,8*16已删除)*/
...
extern const uint8_t bitmap_10[];
extern const uint8_t bitmap_13[];
extern const uint8_t bitmap_15[];
extern const uint8_t bitmap_18[];
